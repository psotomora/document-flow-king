...
export const HISTORIAL_VERSIONES: EntradaVersion[] = [
  {
    ...
    fecha: "2026-09-23",
    cambios: [
      "Nuevo privilegio por usuario Modificar catálogos, que solo un administrador habilita.",
      "El script database/07_permisos_usuario.sql agrega la columna EditarCatalogos (la API también la crea al iniciar).",
    ],
  },
  {
    version: "1.37.8",
  ...
  },
  {
    ...
    fecha: "2026-09-23",
    cambios: [
      "El menú lateral muestra el estado de la licencia y su fecha de vencimiento cuando aplica.",
    ],
  },
  {
    version: "1.37.4",
  ...
  },
  {
    ...
    fecha: "2026-09-23",
    cambios: [
      "Erogaciones: nueva casilla Mostrar facturas en estado pagado; permite registrar el pago de un documento ya pagado en el sistema externo sin cambiar su estado.",
    ],
  },
  {
    version: "1.37.2",
    fecha: "2026-09-17",
    cambios: [
      "Los errores HTML de IIS ahora muestran instrucciones claras para el usuario y un detalle técnico breve para el administrador.",
    ],
  },
  {
    version: "1.37.1",
    fecha: "2026-09-17",
    cambios: [
      "El botón Nueva transferencia aparece arriba, justo debajo de las tarjetas de saldo.",
    ],
  },
  {
    version: "1.37.0",
  ...
  },
  {
    ...
    fecha: "2026-09-15",
    cambios: [
      "La llave pública de licencias se registra desde Parámetros, sin editar archivos de configuración.",
    ],
  },
  {
    version: "1.36.17",
    fecha: "2026-09-15",
    cambios: [
      "El ícono de Aplix se publica desde una dirección estable y compatible con la subcarpeta /cashflow.",
    ],
  },
  {
    version: "1.36.16",
  ...
  },
  {
    ...
    fecha: "2026-09-15",
    cambios: [
      "La publicación incluye una hoja de estilos estable y verifica automáticamente que exista antes de desplegar.",
    ],
  },
  {
    version: "1.36.14",
  ...
  },
  {
    ...
    fecha: "2026-09-15",
    cambios: [
      "El logo se incluye dentro de la publicación y ya no depende del dominio de Lovable.",
    ],
  },
  {
    version: "1.36.12",
  ...
  },
  {
    ...
    fecha: "2026-09-15",
    cambios: [
      "Los errores de envío de correo se explican en lenguaje sencillo, con los pasos a seguir.",
      "El detalle técnico (servidor, puerto, usuario, código SMTP) queda plegado y se puede copiar.",
    ],
  },
  {
    version: "1.36.8",
  ...
  },
  {
    ...
    fecha: "2026-09-12",
    cambios: [
      "Las llaves de licencia se entregan en una sola línea, con botón para copiarlas.",
  ...
  },
  {
    ...
    fecha: "2026-09-12",
    cambios: [
      "En teléfono y tablet aparece un botón de menú que despliega el menú lateral completo.",
      "La barra superior se adapta mejor a pantallas pequeñas.",
    ],
  },
  {
    version: "1.36.4",
    fecha: "2026-09-12",
    cambios: [
      "Se corrige el error al trasladar o archivar contratos del mes: la bitácora usaba un tipo de operación no permitido.",
    ],
  },
  {
    version: "1.36.3",
  ...
  },
  {
    ...
    fecha: "2026-09-12",
    cambios: [
      "Administración muestra la entrada Licencias solo para administradores en la instalación propia.",
      "Nuevo parámetro 'Instalación en equipo del cliente', guardado en la base de datos, que oculta la emisión de licencias.",
    ],
  },
  {
    version: "1.36.1",
    fecha: "2026-09-12",
    cambios: [
      "Contratos por facturar del mes: las facturas asociadas y las marcas de pagado ya no se pierden al recargar, sin importar cuántas líneas se marquen.",
      "Si una preferencia no se puede guardar, ahora se avisa en pantalla en lugar de descartarse en silencio.",
    ],
  },
  {
    version: "1.36.0",
...

  {
    ...
    fecha: "2026-09-11",
    cambios: [
      "Reporte de documentos: nueva casilla en Documentos y en Comparativo anual para elegir entre monto neto (rebajando DEV y NC) o monto bruto.",
    ],
  },
  {
    version: "1.35.4",
