  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ocurrió un error. Puede reintentar o volver al tablero.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Control de Flujo de Efectivo | Aplix Cash Flow Insights" },
      {
        name: "description",
        content:
          "Maqueta del Sistema de Control de Flujo de Efectivo de Aplix Cash Flow Insights: cuentas por cobrar, pagos, erogaciones y proyección.",
      },
      { name: "author", content: "Aplix Cash Flow Insights" },
